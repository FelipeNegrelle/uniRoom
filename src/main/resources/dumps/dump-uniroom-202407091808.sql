...
INSERT INTO `expense` VALUES (7,14,29,21,6,NULL,3,'2024-06-25 23:44:02'),(8,14,27,21,NULL,5,1,'2024-06-25 23:44:10'),(9,15,27,21,5,NULL,2,'2024-06-26 00:41:47'),(10,19,28,21,4,NULL,2,'2024-07-08 13:42:37'),(11,19,27,21,NULL,5,1,'2024-07-09 01:58:42');
...
INSERT INTO `item` VALUES (4,'Coca-Colo',10,28,1),(5,'Pepsi',10.9,27,1),(6,'Guaraná 750 ml',5.5,29,1);
...
INSERT INTO `reservation` VALUES (14,9,46,'C',29,'2024-06-26 00:02:45','2024-06-26 00:02:24','2024-06-25','2024-06-28'),(15,9,46,'CO',29,'2024-06-26 00:40:23','2024-06-26 00:43:23','2024-06-25','2024-06-27'),(16,5,46,'CO',27,'2024-06-28 01:03:00','2024-06-28 01:48:46','2024-06-27','2024-06-28'),(17,7,46,'C',27,'2024-06-28 01:49:10','2024-06-28 01:50:00','2024-06-27','2024-06-28'),(18,3,46,'CO',27,'2024-07-03 01:19:18','2024-07-08 01:19:59','2024-07-02','2024-07-09'),(19,9,46,'CO',29,'2024-07-08 13:29:15','2024-07-09 03:13:55','2024-07-05','2024-07-10');
...
INSERT INTO `reservation_guest` VALUES (14,21),(15,21),(16,21),(17,21),(18,21),(19,21);
...
CREATE TABLE `reservation_movement` (
  ...
  `id_expense` int DEFAULT NULL,
  PRIMARY KEY (`id_reservation_movement`),
  KEY `reservation_movement_reservation_FK` (`id_reservation`),
  KEY `reservation_movement_expense_FK` (`id_expense`),
  CONSTRAINT `reservation_movement_expense_FK` FOREIGN KEY (`id_expense`) REFERENCES `expense` (`id_expense`),
...
INSERT INTO `reservation_movement` VALUES (1,19,20,'Pagamento de Felipe do item Coca-Colo','I','2024-07-09 03:13:47',10),(2,19,0.5000000074505806,'Pagamento da reserva','I','2024-07-09 03:13:55',NULL);
...
INSERT INTO `room_type` VALUES (2,'Suíte',2,150,27,1),(4,'Simples',2,82,27,0),(5,'Luxo',2,200,27,1),(6,'Suite da Filiê',3,130.5,29,1),(7,'Quarto Cringe',10,0.1,29,0);
...
INSERT INTO `service` VALUES (5,'Limpeza de quarto',47.9,27,1),(7,'Limpeza de quarto',25,29,1);
...
-- Dump completed on 2024-07-09 18:08:01
